  ...
  void placeOrder() async {
    ...
    var r = await Requests.post('http://64.227.160.250/api/parcel',
        body: {
          ...
          'senderLat': _currentPosition!.latitude,
          'senderLng': _currentPosition!.longitude,
    ...
    if (json.containsKey('_id')) {
      ...
      var order = await Requests.post('http://64.227.160.250/api/parcel/create-payment',
              body: {
                'orderID': json!['_id'],
                'price': 200,
              },
                    ...
                    child: GestureDetector(
                      onTap: () async {
                        ...
                        setState(() {
                          ...
                          rLat = response['latitude'].toString();
                          rLng = response['longitude'].toString();
                        });
                      },
                      child: Container(
                        width: 170.w,
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    previousButton(),
                    _processIndex == 2 ? submitButton(context) : nextButton(),
                  ],
                ),
              ],
            ),
