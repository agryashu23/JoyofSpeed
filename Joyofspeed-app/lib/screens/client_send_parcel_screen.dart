...
class ClientSendParcelScreen extends StatefulWidget {
  const ClientSendParcelScreen({Key? key}) : super(key: key);

  @override
  State<ClientSendParcelScreen> createState() => _ClientSendParcelScreenState();
}

class _ClientSendParcelScreenState extends State<ClientSendParcelScreen> {
