...
import 'package:joy_of_speed/screens/client_send_parcel_screen.dart';
import 'package:joy_of_speed/screens/client_wallet_screen.dart';
                    ...
                    children: [
                      Center(
                        child: GestureDetector(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>ClientSendParcelScreen()));
                          },
                          child: Container(
                      ...
                      Center(
                        child: GestureDetector(
                          onTap: (){
                            ...
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>ClientWalletScreen()));
                          },
                          child: Container(
                            margin: EdgeInsets.only(top: 10.h),
                            width: 90.w,
